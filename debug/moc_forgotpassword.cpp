...
static constexpr auto qt_meta_stringdata_ZN14ForgotpasswordE = QtMocHelpers::stringData(
    "Forgotpassword",
...
Q_CONSTINIT static const uint qt_meta_data_ZN14ForgotpasswordE[] = {
...
Q_CONSTINIT const QMetaObject Forgotpassword::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14ForgotpasswordE.offsetsAndSizes,
    qt_meta_data_ZN14ForgotpasswordE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14ForgotpasswordE_t,
        // Q_OBJECT / Q_GADGET
...
void Forgotpassword::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_pushButtonChangepassword_clicked(); break;
        default: ;
        }
    }
    (void)_a;
...
void *Forgotpassword::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14ForgotpasswordE.stringdata0))
