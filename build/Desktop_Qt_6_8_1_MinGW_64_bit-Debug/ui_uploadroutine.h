...
public:
    ...
    void setupUi(QDialog *UploadRoutine)
    {
        ...
        formLayoutWidget->setGeometry(QRect(140, 110, 151, 171));
        ...
        pushButton17 = new QPushButton(formLayoutWidget);
        pushButton17->setObjectName("pushButton17");

        formLayout->setWidget(7, QFormLayout::FieldRole, pushButton17);

        formLayoutWidget_2 = new QWidget(UploadRoutine);
        formLayoutWidget_2->setObjectName("formLayoutWidget_2");
        formLayoutWidget_2->setGeometry(QRect(290, 110, 111, 171));
        ...
        pushButton27 = new QPushButton(formLayoutWidget_2);
        pushButton27->setObjectName("pushButton27");

        formLayout_2->setWidget(7, QFormLayout::FieldRole, pushButton27);

        formLayoutWidget_3 = new QWidget(UploadRoutine);
        formLayoutWidget_3->setObjectName("formLayoutWidget_3");
        formLayoutWidget_3->setGeometry(QRect(400, 110, 111, 171));
        ...
        pushButton37 = new QPushButton(formLayoutWidget_3);
        pushButton37->setObjectName("pushButton37");

        formLayout_3->setWidget(7, QFormLayout::FieldRole, pushButton37);
    ...
    void retranslateUi(QDialog *UploadRoutine)
    {
        ...
        pushButton17->setText(QCoreApplication::translate("UploadRoutine", "Add", nullptr));
        ...
        pushButton27->setText(QCoreApplication::translate("UploadRoutine", "Add", nullptr));
        ...
        pushButton37->setText(QCoreApplication::translate("UploadRoutine", "Add", nullptr));
    } // retranslateUi
